...
%global pkg_name rmf_reservation_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-rmf-reservation-msgs
Version:        4.1.0
Release:        1%{?dist}
...
%changelog
* Fri Sep 18 2026 Arjo Chakravarty <arjoc@intrinsic.ai> - 4.1.0-1
- Autogenerated by Bloom

* Wed Apr 29 2026 Arjo Chakravarty <arjo@openrobotics.org> - 4.0.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Arjo Chakravarty <arjo@openrobotics.org> - 4.0.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Arjo Chakravarty <arjo@openrobotics.org> - 4.0.0-1
- Autogenerated by Bloom
