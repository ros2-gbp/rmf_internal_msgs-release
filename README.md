...
## rmf_internal_msgs (kilted) - 3.5.0-1

The packages in the `rmf_internal_msgs` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted rmf_internal_msgs` on `Tue, 20 May 2025 18:34:00 -0000`
...
## rmf_internal_msgs (rolling) - 3.5.0-1

The packages in the `rmf_internal_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling rmf_internal_msgs` on `Mon, 12 May 2025 04:33:33 -0000`
...
## rmf_internal_msgs (rolling) - 3.4.1-1

The packages in the `rmf_internal_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rmf_internal_msgs` on `Wed, 13 Nov 2024 04:05:43 -0000`
...
## rmf_internal_msgs (iron) - 3.1.3-1

The packages in the `rmf_internal_msgs` repository were released into the `iron` distro by running `/usr/bin/bloom-release --rosdistro iron rmf_internal_msgs` on `Fri, 12 Jul 2024 07:11:02 -0000`
...
The packages in the `rmf_internal_msgs` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy rmf_internal_msgs` on `Fri, 14 Jun 2024 19:42:53 -0000`
...
## rmf_internal_msgs (rolling) - 3.4.0-1

The packages in the `rmf_internal_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rmf_internal_msgs` on `Fri, 14 Jun 2024 19:31:31 -0000`
